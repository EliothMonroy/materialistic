...
public class Preferences {
    ...
    public static float getLineHeight(Context context) {
        return getFloatFromString(context, R.string.pref_line_height);
    }

    public static float getReadabilityLineHeight(Context context) {
        return getFloatFromString(context, R.string.pref_readability_line_height);
    }
    ...
    public static void setReleaseNotesSeen(Context context) {
        ...
        setInt(context, R.string.pref_latest_release);
    }
    ...
    private static float getFloatFromString(Context context, @StringRes int key) {
    ...
    private static void setInt(Context context, @StringRes int key) {
        PreferenceManager.getDefaultSharedPreferences(context)
                .edit()
                .putInt(context.getString(key), BuildConfig.LATEST_RELEASE)
                .apply();
    }
    ...
    @Synthetic
    static void set(Context context, @StringRes int key) {
        PreferenceManager.getDefaultSharedPreferences(context)
                .edit()
    ...
    public static class Theme {
        ...
        public static void disableAutoDayNight(Context context) {
            set(context, R.string.pref_daynight_auto);
        }
